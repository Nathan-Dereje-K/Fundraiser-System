    ...
    <div className="relative min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-6 md:px-14 lg:px-20 ">
        ...
        >
          ...
          >
            {t("Discover Causes").split(" ").map((word, index) => (
              <motion.span
                key={index}
        ...
        >
          ...
          >
            {t("Spotlight Initiatives").split(" ").map((word, index) => (
              <motion.span
                key={index}
                className="inline-block mr-2 last:mr-0"
                variants={textVariants}
        ...
        >
          <div className="container mx-auto px-6 md:px-10 lg:px-16">
            ...
            >
              {t("Why Choose Us?").split(" ").map((word, index) => (
                <motion.span
                  key={index}
                  className="inline-block mr-2 last:mr-0"
                  variants={textVariants}
            ...
            >
              {t("We provide a secure, transparent, and user-friendly platform to maximize the impact of your generosity and fundraising efforts.")}
            </motion.p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  {t("Your data and transactions are protected with industry-standard security measures.")}
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  {t("Track donations and campaign progress with clear, real-time reporting. Know where your money goes.")}
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  {t("Easily create campaigns or donate in minutes with our intuitive interface.")}
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  {t("Reach a wider audience and connect with donors passionate about your cause.")}
                </p>
              </motion.div>
            </div>
          </div>
        ...
        >
          <motion.h1
            ...
            animate={isStoriesInView ? "visible" : "hidden"}
          >
            {t("Impact Chronicles").split(" ").map((word, index) => (
              <motion.span
                key={index}
                className="inline-block mr-2 last:mr-0"
                variants={textVariants}
