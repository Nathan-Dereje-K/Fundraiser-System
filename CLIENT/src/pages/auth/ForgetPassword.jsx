    ...
    <div className="flex flex-col justify-center items-center h-screen">
      <div className="w-[450px] bg-gray-50 p-10 rounded-3xl shadow-md">
        ...
        <p className="text-gray-500 text-sm mb-8 leading-relaxed">
          {t("Please enter your registered email address and we will send you password reset instructions to this email.")}
        </p>
        ...
        {isSuccess && (
          <AlertMessage
            type="success"
            message={t("We have emailed instructions on how to reset your password to the email address you specified.")}
          />
        )}
        ...
        >
          {isPending ? t("Sending...") : t("Forgot password?")}
        </button>
